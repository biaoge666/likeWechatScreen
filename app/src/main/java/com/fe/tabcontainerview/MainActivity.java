...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        iconImageArray = new int[]{R.drawable.icon_main, R.drawable.icon_work,
                R.drawable.icon_app, R.drawable.icon_mine};
        selectedIconImageArray = new int[]{R.drawable.icon_main_selected,
                R.drawable.icon_work_selected, R.drawable.icon_app_selected, R.drawable.icon_mine_selected};
        fragments = new Fragment[] {new MainFragment(), new WorkFragment(),
                new AppFragment(), new MineFragment()};

        tabContainerView = (TabContainerView) findViewById(R.id.tab_containerview_main);
        tabContainerView.setAdapter(new DefaultAdapter(this, fragments,
                getSupportFragmentManager(), getResources().getStringArray(R.array.titleArray),
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getItemId() == R.id.action_default) {
                    tabContainerView.setAdapter(new DefaultAdapter(MainActivity.this,
                            fragments, getSupportFragmentManager(), getResources().getStringArray(R.array.titleArray),
                            getResources().getColor(R.color.colorPrimary),
                            iconImageArray, selectedIconImageArray));
                }
                if(item.getItemId() == R.id.action_one) {
                    tabContainerView.setAdapter(new ExampleOneAdapter(MainActivity.this, fragments,
                            getSupportFragmentManager(),
                            getResources().getStringArray(R.array.exampleOneArray)));
                }
                if(item.getItemId() == R.id.action_two) {
                    tabContainerView.setAdapter(new ExampleTwoAdapter(MainActivity.this,
